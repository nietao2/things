...
public class BeanCellMapping {
    ...
    public void populateBean(Object dataString, Map beans) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
        Object bean;
